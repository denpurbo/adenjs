        ...
        <div class="flex flex-col mx-8 md:mx-0 md:space-y-3 md:w-7/12">
          <div class="relative">
            <v-image
              ...
              :loading="getLoading"
              :src="`https://cdn.discordapp.com/avatars/827231418308231218/f6360b0a71dae92aba5ac2fc04ace650?size=1024`"
              draggable="false"
              alt="avatar"
            />
            <div
          ...
          <div>
            ...
            <p
              ...
              xyz="fade left-4"
            >
              {{ new Date().getUTCFullYear() - 1987 }} years old Indonesian, Iam Computer Programming and I try to learn new
  ...
  meta: [
    {
      ...
      } years old Indonesian, Iam Computer Programming and I try to learn new things every day in order to improve myself.`,
    },
    { name: "theme-color", content: "#000000" },
    { property: "og:title", content: "Aden's website" },
    ...
    {
      property: "og:image",
      content: `https://cdn.discordapp.com/avatars/827231418308231218/f6360b0a71dae92aba5ac2fc04ace650?size=1024`,
    },
    //
    {
      name: "twitter:card",
